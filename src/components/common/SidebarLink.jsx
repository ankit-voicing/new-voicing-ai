const SidebarLink = ({ icon, label, active, expanded }) => {
    return (
        <div className={`flex items-center cursor-pointer hover:text-blue-600 transition-colors w-full pr-4 ${active ? 'text-blue-600 ' : 'text-gray-600'}`}>
